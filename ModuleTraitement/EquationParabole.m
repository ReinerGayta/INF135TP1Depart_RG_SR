function [a,b,c] = EquationParabole(x1,y1,x2,y2,x3,y3)
    ...
    %
    %Sortie: les trois coefficients caracteristique de l'equation parabolique
    %
    %Description: fonction qui recois les valeurs x et y de trois points
    %et retourne la valeur des coefficients caracteristiques de l'equation 
    %parabolique des trois points
